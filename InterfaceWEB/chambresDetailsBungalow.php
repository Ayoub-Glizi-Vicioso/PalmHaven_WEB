...
<head>
    ...
    <style>
        ...
        body {
            ...
            font-weight: 300;
            font-style: normal;
            background: url(./images/beach4.png) no-repeat center/cover;
            align-items: center;
        ...
        .container-chambre {
            ...
            margin: 15px 0;
            /* Ajout de la marge uniquement en haut et en bas */
        }
        ...
        height: 400px; /* Assure que le conteneur prend toute la hauteur disponible */
    ...
    .container-image img {/* Assure que l'image occupe toute la hauteur du conteneur */
        ...
        .amenities-boites svg {
            width: 32px;
            /* Taille souhaitée pour la largeur */
            height: 32px;
            /* Taille souhaitée pour la hauteur */
        }
...
<body>
        ...
        <div class="room-details">
            <div class="room-image">
                ...
                <div class="btn-images">
                    <button class="btn" onclick="avant1()">◀︎</button>
                    <button class="btn" onclick="suivant1()">▶︎</button>
                </div>
            </div>
            <div class="room-info">
    ...
    <script src="./script/scriptBungalow.js"></script>
</body>
